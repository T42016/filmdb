...
while($line = db_fetch_array($res))
{
	...
	echo "<td>
			<a href='locations.php?edit=true&amp;id=$line[places_id]' title='�ndra'><img src='img/icon/icon_edit.png' alt='' /></a>
...
<div class="feature">
	...
	?>
		...
		?> /></td></tr>
		<tr><td></td><td><input type="submit" value="<?php if($edit == true) echo "Uppdatera"; else echo "L�gg till"; ?>" class="loginbutton" /></td></tr>
		</table>
	</form>
	<div class="clear">&nbsp;</div>
